  ...
  return (
    <div className="space-y-4">
      <ProviderModelsBlock
        ...
        help="Add favorite model IDs (e.g., openrouter/auto, meta-llama/llama-3.1-8b-instruct, google/gemini-flash-1.5). Set a default applied when you pick OpenRouter in a new chat."
